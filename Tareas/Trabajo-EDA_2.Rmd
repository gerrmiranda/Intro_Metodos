...
\begin{tabular}{||p{2.8 cm}|p{3.5 cm}|p{8 cm}||}
 ...
 \hline\hline
  ...
  \hline
  User\_reviews & numérica continua & Cantidad de usuarios que hicieron review del capítulo \\
  \hline
  Critics\_reviews & Numérica continua & Cantidad de críticas recibidas para el capítulo \\
  \hline
...
A partir del modelo lineal descrito, se observa que por cada millón de televidentes se incrementaba en casi cuatro la cantidad de reseñas y que el piso de reseñas por capítulo es de once.
